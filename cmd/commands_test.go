...
func TestRootRegistersSubcommands(t *testing.T) {
	cmd := NewRootCommand()
	want := map[string]bool{"init": false, "add": false, "refresh": false, "status": false, "remove": false, "release": false, "deploy": false, "build": false, "candidates": false, "attribution": false, "config": false}
